package webservice.tryfourth.service;

import webservice.tryfourth.entity.Phone;
 ...
 * 1. 声明： @webservice
 * 2. 发布 EndPoint
 * 3、发布成功后，访问  http://127.0.0.1:8888/ws/phoneService?WSDL  若成功
 * 4、生成客户端需要的方法
 * wsimport -keep -d E:\ideatest\TEST\rpc\src\main\java -p webservice.tryfourth.phoneclient http://127.0.0.1:8888/ws/phoneService?WSDL
 */
@WebService(serviceName = "PhoneManager", targetNamespace = "http://dd.ws.it.cn")//修改服务名 命名空间 ，默认包名，取反
